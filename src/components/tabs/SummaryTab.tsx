      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="glass-panel p-5 flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <TrendingUp className="text-[var(--color-brand-success)] opacity-80" size={20} />
            <span className="text-label opacity-60">TOTAL INCOME</span>
          </div>
          <span className="text-2xl font-bold text-[var(--color-brand-success)]">
        ...
        <div className="glass-panel p-5 flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <TrendingDown className="text-[var(--color-brand-danger)] opacity-80" size={20} />
            <span className="text-label opacity-60">TOTAL EXPENSE</span>
          </div>
          <span className="text-2xl font-bold text-[var(--color-brand-danger)]">
        ...
        <div className="glass-panel p-5 flex flex-col gap-3">
          <div className="flex items-center gap-2">
            <Target className="text-[var(--color-brand-accent)] opacity-80" size={20} />
            <span className="text-label opacity-60">NET SAVINGS</span>
          </div>
          <span className={`text-2xl font-bold ${annualNet >= 0 ? 'text-[var(--color-brand-success)]' : 'text-[var(--color-brand-danger)]'}`}>
        ...
        <div className="glass-panel p-5 flex flex-col gap-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-label opacity-60 uppercase">SAVINGS RATE</span>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-white/5">
                  <th className="p-4 text-label opacity-60">MONTH</th>
                  <th className="p-4 text-label opacity-60 text-right">INCOME</th>
                  <th className="p-4 text-label opacity-60 text-right">EXPENSE</th>
                  <th className="p-4 text-label opacity-60 text-right">NET</th>
                  <th className="p-4 text-label opacity-60 text-center">SAVINGS</th>
                </tr>
              </thead>
